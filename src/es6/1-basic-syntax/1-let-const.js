...
function testScopes() {
    // console.log(name); //这里会怎么样？let不会做变量提升 ReferenceError: Cannot access uninitialized variable.
 ...
 * 5. 恶心的TDZ（Temporal dead zone）：与Java做对比
 */
let userNames = "damoqiongqiu";
{
    console.log(`尝试访问外层定义的userName>${userNames}`); //这里会很恶心，访问不成功
    let userNames = "大漠穷秋";
}
